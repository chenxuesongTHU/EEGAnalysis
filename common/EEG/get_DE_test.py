...
if __name__ == '__main__':
    ...
    fStart =  [_list[0] for _list in FREQ_BANDS.values()]
    fEnd =  [_list[1] for _list in FREQ_BANDS.values()]
    stft_para = {
        'stftn': 250,
        'fStart': fStart,
        'fEnd': fEnd,
    ...
    DE_PSD(page_eeg_raw.get_data(picks=['eeg']), stft_para)
    print()